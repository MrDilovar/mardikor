...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('applicant.education.higher.store') }}" method="post">
            {{ csrf_field() }}
            <div class="mb-4 ml-2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8 col-md-6 col-lg-4">
                        <input name="university" value="{{ old('university') }}" type="text" class="form-control form-control-sm">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8 col-md-6 col-lg-4">
                        <input name="chair" value="{{ old('chair') }}" type="text" class="form-control form-control-sm">
                        @if ($errors->has('chair'))
                    ...
                    <div class="col-4 col-lg-2">
                        <select name="education_status_id" id="" class="form-control form-control-sm">
                            ...
                            @foreach($education_statuses as $education_status)
                                <option value="{{ $education_status->id }}" {{ old('education_status_id') == $education_status->id ? 'selected' : '' }}>{{ $education_status->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-4 col-lg-2">
                        <select name="graduation" class="form-control form-control-sm">
                            ...
                            @for($i = $current_yer+7; $i >= 1990; $i-- )
                                <option value="{{ $i }}" {{ old('graduation') == $i ? 'selected' : '' }}>{{ $i }}</option>
                            @endfor
                        </select>
                    </div>
                    <div class="col-12">
