            ...
            <div class="mb-4 ml-2">
                    ...
                    <div class="col-4 col-lg-2">
                        <select name="begin_month" id="" class="form-control form-control-sm">
                            ...
                            @foreach($months as $month)
                                <option value="{{ $month->id }}" {{ old('begin_month') == $month->id ? 'selected' : '' }}>{{ $month->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-4 col-lg-2">
                        <select name="begin_yer" id="" class="form-control form-control-sm">
                            ...
                            @for($i = 1990; $i <= $current_yer; $i++ )
                                <option value="{{ $i }}" {{ old('begin_yer') == $i ? 'selected' : '' }}>{{ $i }}</option>
                            @endfor
                        </select>
                    </div>
                    <div class="col-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-4 col-lg-2">
                        <select name="end_month" id="" class="form-control form-control-sm">
                            <option value="0">Месяц</option>
                            @foreach($months as $month)
                                <option value="{{ $month->id }}" {{ old('end_month') == $month->id ? 'selected' : '' }}>{{ $month->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-4 col-lg-2">
                        <select name="end_yer" id="" class="form-control form-control-sm">
                            <option value="0">Год</option>
                            @for($i = 1990; $i <= $current_yer; $i++ )
                                <option value="{{ $i }}" {{ old('end_yer') == $i ? 'selected' : '' }}>{{ $i }}</option>
                            @endfor
                        </select>
                    </div>
                    <div class="col-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8 col-md-6 col-lg-4">
                        <input name="company_name" value="{{ old('company_name') }}" type="text" class="form-control form-control-sm">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8 col-md-6 col-lg-4">
                        <input name="position" value="{{ old('position') }}" type="text" class="form-control form-control-sm">
