...
@section('content')
    <div class="container">
        ...
        <form id="form_vacancy" action="{{ route('employer.vacancy.store') }}" method="post">
            {{ csrf_field() }}
            <div class="mb-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-7 col-lg-4">
                        <div class="row">
                            <div class="col-6">
                                <input name="compensation_from_visible" value="{{ old('compensation_from_visible') }}" type="text" class="form-control form-control-sm" placeholder="от">
                            </div>
                            <div class="col-6">
                                <input name="compensation_to_visible" value="{{ old('compensation_to_visible') }}" type="text" class="form-control form-control-sm" placeholder="до">
                            </div>
                            <div class="col-12">
                    ...
                    <div class="col-7 col-lg-4">
                        <select name="city_id" class="form-control form-control-sm">
                            @foreach($cities as $city)
                                <option value="{{ $city->id }}" {{ (old('city_id') ? old('city_id') : Auth::user()->data->city_id) == $city->id ? 'selected' : '' }}>{{ $city->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-7 col-lg-4">
                        <select name="vacancy_experience_id" class="form-control form-control-sm">
                            @foreach($vacancy_experiences as $vacancy_experience)
                                <option value="{{ $vacancy_experience->id }}" {{ old('vacancy_experience_id') == $vacancy_experience->id ? 'selected' : '' }}>{{ $vacancy_experience->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div id="vacancy_editor" style="height: 250px;">{!! old('description') !!}</div>
                    </div>
                </div>
